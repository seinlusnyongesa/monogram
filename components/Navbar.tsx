  ...
  return (
    <div role="navigation" className="p-4 fixed w-full">
      <nav className="flex justify-between items-center bg-blue text-pink px-2 py-1">
        ...
        <div role="menu" aria-label="desktop menu" className="hidden lg:block">
          <ul className="flex gap-3 uppercase text-xs ">
            <li className="hover:text-orange hover:cursor-pointer">
              how it works
            </li>
            <li className="hover:text-orange hover:cursor-pointer">
              work flows
            </li>
            <li className="hover:text-orange hover:cursor-pointer">download</li>
            <li className="hover:text-orange hover:cursor-pointer">blog</li>
            <li className="hover:text-orange hover:cursor-pointer">support</li>
            <li className="hover:text-orange hover:cursor-pointer">shop</li>
          </ul>
        </div>
        ...
        {showModal && (
          ...
          >
            <motion.div
              ...
              className={`w-[350px] h-screen bg-blue text-pink absolute top-0 left-0`}
              role="menu"
            ...
            >
              ...
              <div>
                <nav className="uppercase pl-20 pr-4 ">
                  <a className="block py-4 border-b-[1px] border-stone-800 hover:text-orange hover:cursor-pointer">
                    how it works
                  </a>
                  <a className="block py-4 border-b-[1px] border-stone-800  hover:text-orange hover:cursor-pointer">
                    work flows
                  </a>
                  <a className="block py-4 border-b-[1px] border-stone-800 ml-4 hover:text-orange hover:cursor-pointer">
                    audio console
                  </a>
                  <a className="block py-4 border-b-[1px]  border-stone-800 ml-4 hover:text-orange hover:cursor-pointer">
                    photo console
                  ...
                  <a className="block py-4 hover:text-orange hover:cursor-pointer">
                    shop
                  </a>
                </nav>
              </div>
